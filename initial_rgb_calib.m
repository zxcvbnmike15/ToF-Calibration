function calib0 = initial_rgb_calib(color_params,color_files,image_params,calib0,...
...
if(isempty(rgb_grid_p))
    [color_params,image_params] = select_rgb_corners(color_params,color_files,image_params);
end
rgb_grid_p = color_params.rgb_grid_p;
rgb_grid_x = color_params.rgb_grid_x;
